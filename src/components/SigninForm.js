...
export default function SigninForm({ setOtp }) {
    ...
    return (
        <>
            <h1 className="text-[28px] leading-8 font-bold text-black mb-8">
                Welcome to Systempackage
            </h1>
            <form className="" onSubmit={handleSubmit}>
                <div className="flex justify-between mb-6 bg-black bg-opacity-5 rounded-xl p-1 border border-transparent hover:border-primary hover:border hover:bg-white overflow-hidden">
                ...
                <button className='w-full flex items-center justify-center bg-primary rounded-xl group text-white mt-8 mb-4 hover:bg-primary-dark p-4 text-base font-bold duration-300' >
